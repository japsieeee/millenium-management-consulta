...
import { LuContact, LuSquareStack } from 'react-icons/lu';
import { MdAccountBalance, MdBusinessCenter, MdOutlinePayments, MdOutlinePrivacyTip } from 'react-icons/md';
	...
	return (
		<div>
			...
			<nav className="text-indigo-900 items-center justify-between p-4 flex lg:hidden box-border h-[60px] border-b fixed top-0 w-full z-50 bg-white">
				...
				<div
					className={`bg-white grid grid-cols-2 gap-y-5 w-full p-5 py-10 right-0 shadow z-40 rounded fixed duration-200 font-bold text-gray-700 ${isOpen
