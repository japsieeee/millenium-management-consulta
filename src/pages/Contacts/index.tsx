 ...
 <Layout>
  <section className='bg-white'>
   <div className='py-8 lg:py-16 px-4 mx-auto max-w-screen-md'>
    <h2 className='mb-4 text-[22px] lg:text-[32px] tracking-tight font-extrabold text-center text-gray-900 animate-jump-in'>
     Contact Us
    </h2>
    <p className='mb-8 lg:mb-16 font-light text-center text-gray-500 text-[16px] lg:text-[22px] animate-jump-in animate-delay-75'>
