...
import MarketPlan from '../../../public/images/png/market-plan.png';
import ResearchAnalysis from '../../../public/images/png/research-analysis.png';
		...
		<div className="p-6 lg:p-10 leading-tight">
			...
			<div className="flex flex-col lg:flex-row gap-10 mt-10 items-center">
				<div className="w-full lg:w-2/6 py-10 flex justify-center lg:justify-start">
					<img src={ResearchAnalysis} alt="report" className="lg:h-full animate-fade-down" />
				</div>
			...
			<div className="flex flex-col lg:flex-row-reverse gap-10 mt-10 items-center">
				<div className="w-full lg:w-3/6 py-10 flex justify-center lg:justify-end">
					<img src={MarketPlan} alt="planning" className="h-full animate-fade-down" />
				</div>
				<div className="w-full lg:w-3/6">
					<h1 className="text-[20px] lg:text-[30px] animate-fade-down font-bold">Market Plan Development</h1>
