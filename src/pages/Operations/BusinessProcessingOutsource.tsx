...
import Management from '../../../public/images/png/friends.png';
import Planning from '../../../public/images/png/planning.png';
		...
		<div className="p-6 lg:p-10 leading-tight">
			...
			<div className="flex flex-col lg:flex-row gap-10 mt-10 items-center">
				<div className="w-full lg:w-2/6 py-10 flex justify-center lg:justify-start">
					<img src={Management} alt="report" className="lg:h-full animate-fade-down" />
				</div>
				<div className="w-full lg:w-4/6">
					<h1 className="text-[20px] lg:text-[30px] animate-fade-down font-bold">Change Management</h1>
			...
			<div className="flex flex-col lg:flex-row-reverse gap-10 mt-10 items-center">
				<div className="w-full lg:w-3/6 py-10 flex justify-center lg:justify-end">
					<img src={Planning} alt="planning" className="h-full animate-fade-down" />
				</div>
